...
import { sendContact } from '../utils/backend.utils'
const ContactUs = ()=>{
    const [contact,setContact]=useState({contactName:"",contactEmail:"",suggestion:""})
    const handlecontact=(e)=>{
        console.log(e.taget)
        setContact(pr =>{return {...pr,[e.target.name]:e.target.value}})
    }
    const submitContact=(e)=>{
        e.preventDefault()
        console.log(contact)
      sendContact(contact).then(d=>console.log(d)).catch(e=>console.log(e))
    }
  return (
        ...
        <div className="flex items-stretch justify-center">
            <div className="grid md:grid-cols-2">
                <div className="h-full pr-6">
                    ...
                    <h4 className='text-center'>You can meet us using the following links</h4>
                    </div>
                    <ul className="mb-6 md:mb-0">
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">Tigray, Mekelle </p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-teal-900 text-gray-50">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">Mail: tigeducation@gmail.com</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-teal-900 text-gray-50">
                ...
                <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                    ...
                    <form id="contactForm" onSubmit={(e)=>submitContact(e)}>
                        <div className="mb-6">
                            <div className="mx-0 mb-1 sm:mb-4">
                                <div className="mx-0 mb-1 sm:mb-4">
                                    <label htmlFor="name" className="pb-1 text-xs uppercase tracking-wider">
                                    </label><input type="text" name="contactName" id="name" autoComplete="given-name"
                                     placeholder="Your name"
                                     value={contact.contactName} onChange={handlecontact}
                                      className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"
                                     />
                                </div>
                                <div className="mx-0 mb-1 sm:mb-4">
                                    <label htmlFor="email" className="pb-1 text-xs uppercase tracking-wider">
                                        </label><input type="email" name="contactEmail" id="email" 
                                        autoComplete="email" placeholder="Your email address"
                                        value={contact.contactEmail} onChange={handlecontact}
                                         className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"
                                         />
                                </div>
                            </div>
                            <div className="mx-0 mb-1 sm:mb-4">
                                <label htmlFor="textarea" className="pb-1 text-xs uppercase tracking-wider">
                                    </label><textarea id="textarea" name="suggestion" cols="30" rows="5"
                                     placeholder="Write your message..." 
                                     value={contact.suggestion} onChange={handlecontact}
                        ...
                        <div className="text-center">
                            <button type="submit"
                             className="w-full bg-teal-800 text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
